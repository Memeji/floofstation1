...
namespace Content.Server.Database
{
    public abstract class ServerDbContext : DbContext
    {
        ...
        public DbSet<RoleWhitelist> RoleWhitelists { get; set; } = null!; //Frontier
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RoleWhitelist>() //Frontier
                .HasOne(w => w.Player)
    ...
    public class Player
    {
        ...
        public List<RoleWhitelist> JobWhitelists { get; set; } = null!; //Frontier
    }
    ...
    public class RoleWhitelist //Frontier Job Whitelists
    {
        [Required, ForeignKey("Player")]
        public Guid PlayerUserId { get; set; }
        public Player Player { get; set; } = default!;
