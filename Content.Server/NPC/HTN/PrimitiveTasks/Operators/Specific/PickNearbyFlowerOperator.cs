...
public sealed partial class PickNearbyFlowerOperator : HTNOperator
{
    ...
    /// </summary>
    [DataField] public string RangeKey = NPCBlackboard.BeeServiceRange;
        ...
        CancellationToken cancelToken)
    {
        ...
        foreach (var target in _lookup.GetEntitiesInRange(owner, range))
        {
            ...
            if (plantHolderComponent.Seed == null || plantHolderComponent.Dead || plantHolderComponent.WaterLevel <= 0f)
                continue;
